...
{
    class UZoneGraphAnnotationTestingComponent* TestingComp;                          // 0x0290 (size: 0x8)
...
{
    bool bEnableDebugDrawing;                                                         // 0x0580 (size: 0x1)
...
{
    TArray<class UZoneGraphAnnotationTest*> Tests;                                    // 0x0568 (size: 0x10)

}; // Size: 0x580

class UZoneGraphDisturbanceAnnotation : public UZoneGraphAnnotationComponent
{
    FZoneGraphTag DangerAnnotationTag;                                                // 0x0588 (size: 0x1)
    FZoneGraphTag ObstacleAnnotationTag;                                              // 0x0589 (size: 0x1)
    FZoneGraphTagFilter AffectedLaneTags;                                             // 0x058C (size: 0xC)
    FZoneGraphTagFilter EscapeLaneTags;                                               // 0x0598 (size: 0xC)
    float IdealSpanLength;                                                            // 0x05A4 (size: 0x4)
    class UZoneGraphSubsystem* ZoneGraphSubsystem;                                    // 0x05E8 (size: 0x8)
