...
struct FCompactStateTransition
{
    ...
    uint16 ConditionsBegin;                                                           // 0x0008 (size: 0x2)
    FStateTreeStateHandle State;                                                      // 0x000A (size: 0x2)
    FStateTreeRandomTimeDuration Delay;                                               // 0x000C (size: 0x4)
    EStateTreeTransitionTrigger Trigger;                                              // 0x0010 (size: 0x1)
    EStateTreeTransitionPriority Priority;                                            // 0x0011 (size: 0x1)
    EStateTreeSelectionFallback Fallback;                                             // 0x0012 (size: 0x1)
    uint8 ConditionsNum;                                                              // 0x0013 (size: 0x1)
    uint8 bTransitionEnabled;                                                         // 0x0014 (size: 0x1)
...
struct FCompactStateTreeState
{
    ...
    FStateTreeStateHandle LinkedState;                                                // 0x0008 (size: 0x2)
    class UStateTree* LinkedAsset;                                                    // 0x0010 (size: 0x8)
    FStateTreeStateHandle Parent;                                                     // 0x0018 (size: 0x2)
    uint16 ChildrenBegin;                                                             // 0x001A (size: 0x2)
    uint16 ChildrenEnd;                                                               // 0x001C (size: 0x2)
    uint16 EnterConditionsBegin;                                                      // 0x001E (size: 0x2)
    uint16 TransitionsBegin;                                                          // 0x0020 (size: 0x2)
    uint16 TasksBegin;                                                                // 0x0022 (size: 0x2)
    FStateTreeIndex16 ParameterTemplateIndex;                                         // 0x0024 (size: 0x2)
    FStateTreeDataHandle ParameterDataHandle;                                         // 0x0026 (size: 0x6)
    FStateTreeIndex16 ParameterBindingsBatch;                                         // 0x002C (size: 0x2)
    uint8 EnterConditionsNum;                                                         // 0x002E (size: 0x1)
    uint8 TransitionsNum;                                                             // 0x002F (size: 0x1)
    uint8 TasksNum;                                                                   // 0x0030 (size: 0x1)
    uint8 InstanceDataNum;                                                            // 0x0031 (size: 0x1)
    EStateTreeStateType Type;                                                         // 0x0032 (size: 0x1)
    EStateTreeStateSelectionBehavior SelectionBehavior;                               // 0x0033 (size: 0x1)
    uint8 bHasTransitionTasks;                                                        // 0x0034 (size: 0x1)
    uint8 bEnabled;                                                                   // 0x0034 (size: 0x1)
...
{
    EStateTreeConditionOperand Operand;                                               // 0x0020 (size: 0x1)
...
{
    TArray<FStateTreeEvent> Events;                                                   // 0x0000 (size: 0x10)
...
{
    FStateTreeExecutionState ExecutionState;                                          // 0x0000 (size: 0x30)
    FInstancedStructContainer InstanceStructs;                                        // 0x0030 (size: 0x10)
    TArray<FStateTreeTemporaryInstanceData> TemporaryInstances;                       // 0x0040 (size: 0x10)
    FStateTreeEventQueue EventQueue;                                                  // 0x0050 (size: 0x10)
    TArray<FStateTreeTransitionRequest> TransitionRequests;                           // 0x0060 (size: 0x10)
    FInstancedPropertyBag GlobalParameters;                                           // 0x0070 (size: 0x10)
...
struct FStateTreePropertyCopyBatch
{
    ...
    uint16 BindingsBegin;                                                             // 0x0018 (size: 0x2)
    uint16 BindingsEnd;                                                               // 0x001A (size: 0x2)
...
struct FStateTreeTransitionResult
{
    ...
    EStateTreeRunStatus CurrentRunStatus;                                             // 0x0010 (size: 0x1)
    FStateTreeStateHandle SourceState;                                                // 0x0012 (size: 0x2)
    FStateTreeStateHandle TargetState;                                                // 0x0014 (size: 0x2)
    FStateTreeStateHandle CurrentState;                                               // 0x0016 (size: 0x2)
    EStateTreeStateChangeType ChangeType;                                             // 0x0018 (size: 0x1)
    EStateTreeTransitionPriority Priority;                                            // 0x0019 (size: 0x1)
    class UStateTree* SourceStateTree;                                                // 0x0020 (size: 0x8)
    FStateTreeStateHandle SourceRootState;                                            // 0x0028 (size: 0x2)
...
{
    uint8 bShouldStateChangeOnReselect;                                               // 0x0041 (size: 0x1)
    uint8 bShouldCallTickOnlyOnEvents;                                                // 0x0041 (size: 0x1)
    uint8 bShouldCopyBoundPropertiesOnTick;                                           // 0x0041 (size: 0x1)
    uint8 bShouldCopyBoundPropertiesOnExitState;                                      // 0x0041 (size: 0x1)
