#ifndef UE4SS_SDK_W_Glossary_SpinBox_HPP
#define UE4SS_SDK_W_Glossary_SpinBox_HPP

class UW_Glossary_SpinBox_C : public UIntegerPickerWidget
{
    ...
    class UTextBlock* TextBlock_Number;                                               // 0x0408 (size: 0x8)
    class UWidgetSwitcher* WidgetSwitcher_Decrease;                                   // 0x0410 (size: 0x8)
    class UWidgetSwitcher* WidgetSwitcher_Increase;                                   // 0x0418 (size: 0x8)
    ...
    void ExecuteUbergraph_W_Glossary_SpinBox(int32 EntryPoint);
}; // Size: 0x470
