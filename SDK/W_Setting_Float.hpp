#ifndef UE4SS_SDK_W_Setting_Float_HPP
#define UE4SS_SDK_W_Setting_Float_HPP

class UW_Setting_Float_C : public USettingObjectWidget_Float
{
    ...
    void BndEvt__W_Setting_Float_Slider_K2Node_ComponentBoundEvent_1_OnMouseCaptureEndEvent__DelegateSignature();
    void BndEvt__W_Setting_Float_Slider_K2Node_ComponentBoundEvent_2_OnMouseCaptureBeginEvent__DelegateSignature();
    void OnInputTypeChanged(ECommonInputType _InputType);
    void PreConstruct(bool IsDesignTime);
    void OnContentChanged();
    void ExecuteUbergraph_W_Setting_Float(int32 EntryPoint);
}; // Size: 0x40A
