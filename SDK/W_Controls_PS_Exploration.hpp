#ifndef UE4SS_SDK_W_Controls_PS_Exploration_HPP
#define UE4SS_SDK_W_Controls_PS_Exploration_HPP

class UW_Controls_PS_Exploration_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_W_Controls_PS_Exploration(int32 EntryPoint);
}; // Size: 0x3A0
