...
struct FNavCollisionCustomConvex
{
...
class UNavCollision : public UNavCollisionBase
{
    ...
    TArray<FNavCollisionCustomConvex> CustomConvexCollision;                          // 0x00D8 (size: 0x10)
    TOptional<FNavCollisionCustomConvex> CustomSimplifiedCollision;                   // 0x00E8 (size: 0x28)
    TSubclassOf<class UNavArea> AreaClass;                                            // 0x0110 (size: 0x8)
    uint8 bGatherConvexGeometry;                                                      // 0x0118 (size: 0x1)
    uint8 bCreateOnClient;                                                            // 0x0118 (size: 0x1)
