...
{
    int32 ExecutionFlags;                                                             // 0x0028 (size: 0x4)
    EMassProcessingPhase ProcessingPhase;                                             // 0x002C (size: 0x1)
    FMassProcessorExecutionOrder ExecutionOrder;                                      // 0x0030 (size: 0x28)
    bool bAutoRegisterWithProcessingPhases;                                           // 0x0058 (size: 0x1)
    bool bRequiresGameThreadExecution;                                                // 0x005B (size: 0x1)
