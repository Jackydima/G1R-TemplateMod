#ifndef UE4SS_SDK_Cryptex_A_HPP
#define UE4SS_SDK_Cryptex_A_HPP

class ACryptex_A_C : public AInteractiveObjectActor
{
    ...
    void ExecuteUbergraph_Cryptex_A(int32 EntryPoint);
}; // Size: 0x960
