#ifndef UE4SS_SDK_W_Writings_Page_Content_HPP
#define UE4SS_SDK_W_Writings_Page_Content_HPP

class UW_Writings_Page_Content_C : public UDocumentElementViewItemWidget
{
    ...
    void OnLoaded_246FD1274E7E236B1F6ACDA8F7E26E7C(class UObject* Loaded);
    ...
    void ExecuteUbergraph_W_Writings_Page_Content(int32 EntryPoint);
}; // Size: 0x490
