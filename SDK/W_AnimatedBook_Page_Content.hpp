#ifndef UE4SS_SDK_W_AnimatedBook_Page_Content_HPP
#define UE4SS_SDK_W_AnimatedBook_Page_Content_HPP

class UW_AnimatedBook_Page_Content_C : public UDocumentElementViewItemWidget
{
    ...
    void OnLoaded_378DCE9945BB5BD1C6EAF68E4205F0AA(class UObject* Loaded);
    ...
    void ExecuteUbergraph_W_AnimatedBook_Page_Content(int32 EntryPoint);
}; // Size: 0x490
