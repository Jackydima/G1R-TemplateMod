...
struct FZoneGraphBuildSettings
{
    ...
    float DragEndpointAutoConnectRange;                                               // 0x0040 (size: 0x4)
...
{
    bool bEnableDrawing;                                                              // 0x0291 (size: 0x1)
    class UZoneGraphRenderingComponent* RenderingComp;                                // 0x0298 (size: 0x8)
    FZoneGraphStorage ZoneStorage;                                                    // 0x02A0 (size: 0xF0)
    uint32 CombinedShapeHash;                                                         // 0x03B8 (size: 0x4)

}; // Size: 0x3C0

class AZoneShape : public AActor
{
    class UZoneShapeComponent* ShapeComponent;                                        // 0x0290 (size: 0x8)
...
class UZoneGraphSettings : public UDeveloperSettings
{
    ...
    FZoneGraphBuildSettings BuildSettings;                                            // 0x0250 (size: 0x48)
    bool bBuildZoneGraphWhileEditing;                                                 // 0x0298 (size: 0x1)
...
{
    FZoneLaneProfileRef LaneProfile;                                                  // 0x0518 (size: 0x18)
    bool bReverseLaneProfile;                                                         // 0x0530 (size: 0x1)
    TArray<FZoneLaneProfileRef> PerPointLaneProfiles;                                 // 0x0538 (size: 0x10)
    TArray<FZoneShapePoint> Points;                                                   // 0x0548 (size: 0x10)
    FZoneShapeType ShapeType;                                                         // 0x0558 (size: 0x1)
    EZoneShapePolygonRoutingType PolygonRoutingType;                                  // 0x0559 (size: 0x1)
    FZoneGraphTagMask Tags;                                                           // 0x055C (size: 0x4)
    TArray<FZoneShapeConnector> ShapeConnectors;                                      // 0x0560 (size: 0x10)
    TArray<FZoneShapeConnection> ConnectedShapes;                                     // 0x0570 (size: 0x10)
