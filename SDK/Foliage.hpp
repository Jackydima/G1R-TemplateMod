...
class UFoliageType : public UObject
{
    ...
    bool bAllowDynamicShadowsInHLOD;                                                  // 0x0188 (size: 0x1)
    uint8 bCastDynamicShadow;                                                         // 0x018C (size: 0x1)
    uint8 bCastStaticShadow;                                                          // 0x018C (size: 0x1)
    uint8 bCastContactShadow;                                                         // 0x0190 (size: 0x1)
    uint8 bCastShadowAsTwoSided;                                                      // 0x0194 (size: 0x1)
    uint8 bReceivesDecals;                                                            // 0x0194 (size: 0x1)
    uint8 bOverrideLightMapRes;                                                       // 0x0194 (size: 0x1)
    EShadowCacheInvalidationBehavior ShadowCacheInvalidationBehavior;                 // 0x0198 (size: 0x1)
    int32 OverriddenLightMapRes;                                                      // 0x019C (size: 0x4)
    ELightmapType LightmapType;                                                       // 0x01A0 (size: 0x1)
    uint8 bUseAsOccluder;                                                             // 0x01A4 (size: 0x1)
    uint8 bVisibleInRayTracing;                                                       // 0x01A8 (size: 0x1)
    uint8 bEvaluateWorldPositionOffset;                                               // 0x01A8 (size: 0x1)
    int32 WorldPositionOffsetDisableDistance;                                         // 0x01AC (size: 0x4)
    FBodyInstance BodyInstance;                                                       // 0x01B0 (size: 0x198)
    TEnumAsByte<EHasCustomNavigableGeometry::Type> CustomNavigableGeometry;           // 0x0348 (size: 0x1)
    FLightingChannels LightingChannels;                                               // 0x0349 (size: 0x1)
    uint8 bRenderCustomDepth;                                                         // 0x034C (size: 0x1)
    ERendererStencilMask CustomDepthStencilWriteMask;                                 // 0x0350 (size: 0x1)
    int32 CustomDepthStencilValue;                                                    // 0x0354 (size: 0x4)
    int32 TranslucencySortPriority;                                                   // 0x0358 (size: 0x4)
    float CollisionRadius;                                                            // 0x035C (size: 0x4)
    float ShadeRadius;                                                                // 0x0360 (size: 0x4)
    int32 NumSteps;                                                                   // 0x0364 (size: 0x4)
    float InitialSeedDensity;                                                         // 0x0368 (size: 0x4)
    float AverageSpreadDistance;                                                      // 0x036C (size: 0x4)
    float SpreadVariance;                                                             // 0x0370 (size: 0x4)
    int32 SeedsPerStep;                                                               // 0x0374 (size: 0x4)
    int32 DistributionSeed;                                                           // 0x0378 (size: 0x4)
    float MaxInitialSeedOffset;                                                       // 0x037C (size: 0x4)
    bool bCanGrowInShade;                                                             // 0x0380 (size: 0x1)
    bool bSpawnsInShade;                                                              // 0x0381 (size: 0x1)
    float MaxInitialAge;                                                              // 0x0384 (size: 0x4)
    float MaxAge;                                                                     // 0x0388 (size: 0x4)
    float OverlapPriority;                                                            // 0x038C (size: 0x4)
    FFloatInterval ProceduralScale;                                                   // 0x0390 (size: 0x8)
    FRuntimeFloatCurve ScaleCurve;                                                    // 0x0398 (size: 0x88)
    FFoliageDensityFalloff DensityFalloff;                                            // 0x0420 (size: 0x90)
    int32 ChangeCount;                                                                // 0x04B0 (size: 0x4)
    uint8 ReapplyDensity;                                                             // 0x04B4 (size: 0x1)
    uint8 ReapplyRadius;                                                              // 0x04B4 (size: 0x1)
    uint8 ReapplyAlignToNormal;                                                       // 0x04B4 (size: 0x1)
    uint8 ReapplyRandomYaw;                                                           // 0x04B4 (size: 0x1)
    uint8 ReapplyScaling;                                                             // 0x04B4 (size: 0x1)
    uint8 ReapplyScaleX;                                                              // 0x04B4 (size: 0x1)
    uint8 ReapplyScaleY;                                                              // 0x04B4 (size: 0x1)
    uint8 ReapplyScaleZ;                                                              // 0x04B4 (size: 0x1)
    uint8 ReapplyRandomPitchAngle;                                                    // 0x04B5 (size: 0x1)
    uint8 ReapplyGroundSlope;                                                         // 0x04B5 (size: 0x1)
    uint8 ReapplyHeight;                                                              // 0x04B5 (size: 0x1)
    uint8 ReapplyLandscapeLayers;                                                     // 0x04B5 (size: 0x1)
    uint8 ReapplyZOffset;                                                             // 0x04B5 (size: 0x1)
    uint8 ReapplyCollisionWithWorld;                                                  // 0x04B5 (size: 0x1)
    uint8 ReapplyVertexColorMask;                                                     // 0x04B5 (size: 0x1)
    uint8 bEnableDensityScaling;                                                      // 0x04B5 (size: 0x1)
    uint8 bEnableDiscardOnLoad;                                                       // 0x04B6 (size: 0x1)
    uint8 bEnableCullDistanceScaling;                                                 // 0x04B6 (size: 0x1)
    TArray<class URuntimeVirtualTexture*> RuntimeVirtualTextures;                     // 0x04B8 (size: 0x10)
    int32 VirtualTextureCullMips;                                                     // 0x04C8 (size: 0x4)
    ERuntimeVirtualTextureMainPassType VirtualTextureRenderPassType;                  // 0x04CC (size: 0x1)

}; // Size: 0x4D0

class UFoliageType_Actor : public UFoliageType
{
    TSubclassOf<class AActor> ActorClass;                                             // 0x04D0 (size: 0x8)
    bool bShouldAttachToBaseComponent;                                                // 0x04D8 (size: 0x1)
    bool bStaticMeshOnly;                                                             // 0x04D9 (size: 0x1)
    TSubclassOf<class UFoliageInstancedStaticMeshComponent> StaticMeshOnlyComponentClass; // 0x04E0 (size: 0x8)

}; // Size: 0x4E8

class UFoliageType_InstancedStaticMesh : public UFoliageType
{
    class UStaticMesh* Mesh;                                                          // 0x04D0 (size: 0x8)
    TArray<class UMaterialInterface*> OverrideMaterials;                              // 0x04D8 (size: 0x10)
    TArray<class UMaterialInterface*> NaniteOverrideMaterials;                        // 0x04E8 (size: 0x10)
    TSubclassOf<class UFoliageInstancedStaticMeshComponent> ComponentClass;           // 0x04F8 (size: 0x8)
