...
class UMotionWarpingComponent : public UActorComponent
{
    ...
    void AddOrUpdateWarpTargetFromComponent(FName WarpTargetName, const class USceneComponent* Component, FName BoneName, bool bFollowComponent, FVector LocationOffset, FRotator RotationOffset);
...
{
    bool bWarpIKBones;                                                                // 0x0260 (size: 0x1)
    TArray<FName> IKBones;                                                            // 0x0268 (size: 0x10)
    FTransform CachedMeshTransform;                                                   // 0x0280 (size: 0x60)
    FTransform CachedMeshRelativeTransform;                                           // 0x02E0 (size: 0x60)
    FTransform CachedRootMotion;                                                      // 0x0340 (size: 0x60)
    FAnimSequenceTrackContainer Result;                                               // 0x03A0 (size: 0x20)
...
class URootMotionModifier_Warp : public URootMotionModifier
{
    ...
    EMotionWarpRotationMethod RotationMethod;                                         // 0x017A (size: 0x1)
    float WarpRotationTimeMultiplier;                                                 // 0x017C (size: 0x4)
    float WarpMaxRotationRate;                                                        // 0x0180 (size: 0x4)
    FTransform CachedTargetTransform;                                                 // 0x0190 (size: 0x60)
