...
{
    FMovieGraphTraversalContext UserContext;                                          // 0x0000 (size: 0xD0)
    TMap<class UMovieGraphConfig*, class FMovieGraphEvaluationContext_VisitedNodeInfo> VisitedNodesByOwningGraph; // 0x00D0 (size: 0x50)
    class UMovieGraphPin* PinBeingFollowed;                                           // 0x0120 (size: 0x8)
    TArray<class UMovieGraphSubgraphNode*> SubgraphStack;                             // 0x0128 (size: 0x10)
    bool bCircularGraphReferenceFound;                                                // 0x0138 (size: 0x1)
    FText TraversalError;                                                             // 0x0140 (size: 0x10)
...
struct FMovieGraphPinProperties
{
    ...
    bool bIsBuiltIn;                                                                  // 0x001A (size: 0x1)
...
struct FMovieGraphPropertyInfo
{
    ...
    bool bIsDynamicProperty;                                                          // 0x0008 (size: 0x1)
    EMovieGraphValueType ValueType;                                                   // 0x0009 (size: 0x1)
    class UObject* ValueTypeObject;                                                   // 0x0010 (size: 0x8)
...
struct FMovieGraphTimeStepData
{
    ...
    float WorldSeconds;                                                               // 0x0014 (size: 0x4)
    float MotionBlurFraction;                                                         // 0x0018 (size: 0x4)
    FFrameRate FrameRate;                                                             // 0x001C (size: 0x8)
    int32 TemporalSampleIndex;                                                        // 0x0024 (size: 0x4)
    int32 TemporalSampleCount;                                                        // 0x0028 (size: 0x4)
    bool bIsFirstTemporalSampleForFrame;                                              // 0x002C (size: 0x1)
    bool bIsLastTemporalSampleForFrame;                                               // 0x002D (size: 0x1)
    bool bDiscardOutput;                                                              // 0x002E (size: 0x1)
    bool bRequiresAccumulator;                                                        // 0x002F (size: 0x1)
    class UMovieGraphEvaluatedConfig* EvaluatedConfig;                                // 0x0030 (size: 0x8)
    FTimecode RootTimeCode;                                                           // 0x0038 (size: 0x14)
    FFrameNumber RootFrameNumber;                                                     // 0x004C (size: 0x4)
    FTimecode ShotTimeCode;                                                           // 0x0050 (size: 0x14)
    FFrameNumber ShotFrameNumber;                                                     // 0x0064 (size: 0x4)
...
struct FMovieGraphTraversalContext
{
    ...
    FMovieGraphTimeStepData Time;                                                     // 0x0068 (size: 0x68)
...
{
    uint8 bOverride_ConsoleVariablePreset;                                            // 0x0098 (size: 0x1)
    TScriptInterface<class IMovieSceneConsoleVariableTrackInterface> ConsoleVariablePreset; // 0x00A0 (size: 0x10)
...
class UMovieGraphBlueprintLibrary : public UBlueprintFunctionLibrary
{
    ...
    FIntPoint GetEffectiveOutputResolution(class UMovieGraphEvaluatedConfig* InEvaluatedGraph);
    ...
    float GetCurrentFocusDistance(const class UMovieGraphPipeline* InMovieGraphPipeline);
    float GetCurrentFocalLength(const class UMovieGraphPipeline* InMovieGraphPipeline);
    class UCineCameraComponent* GetCurrentCineCamera(const class UMovieGraphPipeline* InMovieGraphPipeline);
    float GetCurrentAperture(const class UMovieGraphPipeline* InMovieGraphPipeline);
...
{
    uint8 bOverride_BurnInClass;                                                      // 0x0110 (size: 0x1)
    FSoftClassPath BurnInClass;                                                       // 0x0118 (size: 0x20)
    TMap<class UClass*, class UMovieGraphBurnInWidget*> BurnInWidgetInstances;        // 0x0138 (size: 0x50)
...
{
    uint8 bOverride_ShutterTiming;                                                    // 0x0098 (size: 0x1)
    uint8 bOverride_OverscanPercentage;                                               // 0x0098 (size: 0x1)
    EMoviePipelineShutterTiming ShutterTiming;                                        // 0x0099 (size: 0x1)
    float OverscanPercentage;                                                         // 0x009C (size: 0x4)
...
{
    uint8 bOverride_Collection;                                                       // 0x0098 (size: 0x1)
    class UMovieGraphCollection* Collection;                                          // 0x00A0 (size: 0x8)

}; // Size: 0xA8

class UMovieGraphCommandLineEncoderNode : public UMovieGraphSettingNode
{
    uint8 bOverride_FileNameFormat;                                                   // 0x00A0 (size: 0x1)
    uint8 bOverride_bDeleteSourceFiles;                                               // 0x00A0 (size: 0x1)
    uint8 bOverride_bSkipEncodeOnRenderCanceled;                                      // 0x00A0 (size: 0x1)
    uint8 bOverride_VideoCodec;                                                       // 0x00A0 (size: 0x1)
    uint8 bOverride_AudioCodec;                                                       // 0x00A0 (size: 0x1)
    uint8 bOverride_OutputFileExtension;                                              // 0x00A0 (size: 0x1)
    uint8 bOverride_CommandLineFormat;                                                // 0x00A0 (size: 0x1)
    uint8 bOverride_VideoInputStringFormat;                                           // 0x00A0 (size: 0x1)
    uint8 bOverride_AudioInputStringFormat;                                           // 0x00A1 (size: 0x1)
    uint8 bOverride_EncodeSettings;                                                   // 0x00A1 (size: 0x1)
    uint8 bOverride_bRetainInputTextFiles;                                            // 0x00A1 (size: 0x1)
    FString FileNameFormat;                                                           // 0x00A8 (size: 0x10)
    bool bDeleteSourceFiles;                                                          // 0x00B8 (size: 0x1)
    bool bSkipEncodeOnRenderCanceled;                                                 // 0x00B9 (size: 0x1)
    FString VideoCodec;                                                               // 0x00C0 (size: 0x10)
    FString AudioCodec;                                                               // 0x00D0 (size: 0x10)
    FString OutputFileExtension;                                                      // 0x00E0 (size: 0x10)
    FString CommandLineFormat;                                                        // 0x00F0 (size: 0x10)
    FString VideoInputStringFormat;                                                   // 0x0100 (size: 0x10)
    FString AudioInputStringFormat;                                                   // 0x0110 (size: 0x10)
    FString EncodeSettings;                                                           // 0x0120 (size: 0x10)
    bool bRetainInputTextFiles;                                                       // 0x0130 (size: 0x1)
...
class UMovieGraphConditionGroup : public UObject
{
    ...
    TSet<AActor*> QueryResult;                                                        // 0x0050 (size: 0x50)
    TSet<AActor*> EvaluationResult;                                                   // 0x00A0 (size: 0x50)
...
{
    FMovieGraphTimeStepData CurrentTimeStepData;                                      // 0x0028 (size: 0x68)
...
{
    uint8 bOverride_bCaptureFramesWithRenderDoc;                                      // 0x0098 (size: 0x1)
    uint8 bOverride_bCaptureUnrealInsightsTrace;                                      // 0x0098 (size: 0x1)
    uint8 bOverride_UnrealInsightsTraceFileNameFormat;                                // 0x0098 (size: 0x1)
    bool bCaptureFramesWithRenderDoc;                                                 // 0x0099 (size: 0x1)
    bool bCaptureUnrealInsightsTrace;                                                 // 0x009A (size: 0x1)
    FString UnrealInsightsTraceFileNameFormat;                                        // 0x00A0 (size: 0x10)
...
{
    uint8 bOverride_Script;                                                           // 0x0098 (size: 0x1)
    FSoftClassPath Script;                                                            // 0x00A0 (size: 0x20)

}; // Size: 0xC0

class UMovieGraphFileOutputNode : public UMovieGraphSettingNode
{
    uint8 bOverride_FileNameFormat;                                                   // 0x0098 (size: 0x1)
    FString FileNameFormat;                                                           // 0x00A0 (size: 0x10)

}; // Size: 0xB0

class UMovieGraphGlobalGameOverridesNode : public UMovieGraphSettingNode
{
    uint8 bOverride_GameModeOverride;                                                 // 0x0098 (size: 0x1)
    uint8 bOverride_ScalabilityQualityLevel;                                          // 0x0098 (size: 0x1)
    uint8 bOverride_bDisableTextureStreaming;                                         // 0x0098 (size: 0x1)
    uint8 bOverride_bDisableLODs;                                                     // 0x0098 (size: 0x1)
    uint8 bOverride_bDisableHLODs;                                                    // 0x0098 (size: 0x1)
    uint8 bOverride_bFlushLevelStreaming;                                             // 0x0098 (size: 0x1)
    uint8 bOverride_bFlushAssetCompiler;                                              // 0x0098 (size: 0x1)
    uint8 bOverride_bFlushShaderCompiler;                                             // 0x0098 (size: 0x1)
    uint8 bOverride_bFlushGrassStreaming;                                             // 0x0099 (size: 0x1)
    uint8 bOverride_bFlushStreamingManagers;                                          // 0x0099 (size: 0x1)
    uint8 bOverride_VirtualTextureFeedbackFactor;                                     // 0x0099 (size: 0x1)
    TSubclassOf<class AGameModeBase> GameModeOverride;                                // 0x00A0 (size: 0x8)
    EMovieGraphScalabilityQualityLevel ScalabilityQualityLevel;                       // 0x00A8 (size: 0x1)
    bool bDisableTextureStreaming;                                                    // 0x00A9 (size: 0x1)
    bool bDisableLODs;                                                                // 0x00AA (size: 0x1)
    bool bDisableHLODs;                                                               // 0x00AB (size: 0x1)
    bool bFlushLevelStreaming;                                                        // 0x00AC (size: 0x1)
    bool bFlushAssetCompiler;                                                         // 0x00AD (size: 0x1)
    bool bFlushShaderCompiler;                                                        // 0x00AE (size: 0x1)
    bool bFlushGrassStreaming;                                                        // 0x00AF (size: 0x1)
    bool bFlushStreamingManagers;                                                     // 0x00B0 (size: 0x1)
    int32 VirtualTextureFeedbackFactor;                                               // 0x00B4 (size: 0x4)

}; // Size: 0x150

class UMovieGraphGlobalOutputSettingNode : public UMovieGraphSettingNode
{
    uint8 bOverride_OutputDirectory;                                                  // 0x0098 (size: 0x1)
    uint8 bOverride_OutputResolution;                                                 // 0x0098 (size: 0x1)
    uint8 bOverride_OutputFrameRate;                                                  // 0x0098 (size: 0x1)
    uint8 bOverride_bOverwriteExistingOutput;                                         // 0x0098 (size: 0x1)
    uint8 bOverride_ZeroPadFrameNumbers;                                              // 0x0098 (size: 0x1)
    uint8 bOverride_FrameNumberOffset;                                                // 0x0098 (size: 0x1)
    uint8 bOverride_HandleFrameCount;                                                 // 0x0098 (size: 0x1)
    uint8 bOverride_CustomPlaybackRangeStartFrame;                                    // 0x0098 (size: 0x1)
    uint8 bOverride_CustomPlaybackRangeEndFrame;                                      // 0x0099 (size: 0x1)
    uint8 bOverride_VersioningSettings;                                               // 0x0099 (size: 0x1)
    uint8 bOverride_bFlushDiskWritesPerShot;                                          // 0x0099 (size: 0x1)
    FDirectoryPath OutputDirectory;                                                   // 0x00A0 (size: 0x10)
    FMovieGraphNamedResolution OutputResolution;                                      // 0x00B0 (size: 0x20)
    FFrameRate OutputFrameRate;                                                       // 0x00D0 (size: 0x8)
    bool bOverwriteExistingOutput;                                                    // 0x00D8 (size: 0x1)
    int32 ZeroPadFrameNumbers;                                                        // 0x00DC (size: 0x4)
    int32 FrameNumberOffset;                                                          // 0x00E0 (size: 0x4)
    int32 HandleFrameCount;                                                           // 0x00E4 (size: 0x4)
    int32 CustomPlaybackRangeStartFrame;                                              // 0x00E8 (size: 0x4)
    int32 CustomPlaybackRangeEndFrame;                                                // 0x00EC (size: 0x4)
    FMovieGraphVersioningSettings VersioningSettings;                                 // 0x00F0 (size: 0x8)
    bool bFlushDiskWritesPerShot;                                                     // 0x00F8 (size: 0x1)
...
{
    uint8 bOverride_ModifierName;                                                     // 0x0098 (size: 0x1)
    FString ModifierName;                                                             // 0x00A0 (size: 0x10)
    uint8 bOverride_Collections;                                                      // 0x00B0 (size: 0x1)
    uint8 bOverride_ModifiersContainer;                                               // 0x00B0 (size: 0x1)
    TArray<FName> Collections;                                                        // 0x00B8 (size: 0x10)
    class UMovieGraphMergeableModifierContainer* ModifiersContainer;                  // 0x00C8 (size: 0x8)
...
{
    TArray<class UMovieGraphPin*> InputPins;                                          // 0x0040 (size: 0x10)
    TArray<class UMovieGraphPin*> OutputPins;                                         // 0x0050 (size: 0x10)
    FInstancedPropertyBag DynamicProperties;                                          // 0x0060 (size: 0x10)
    TArray<FMovieGraphPropertyInfo> ExposedPropertyInfo;                              // 0x0070 (size: 0x10)
    uint8 bIsDisabled;                                                                // 0x0080 (size: 0x1)
    FGuid Guid;                                                                       // 0x0084 (size: 0x10)
...
class UMovieGraphPipeline : public UMoviePipelineBase
{
    ...
    TArray<class UMoviePipelineExecutorShot*> ActiveShotList;                         // 0x00C8 (size: 0x10)
    TSubclassOf<class UMovieGraphRenderPreviewWidget> PreviewWidgetClassToUse;        // 0x00D8 (size: 0x8)
    class UMovieGraphRenderPreviewWidget* PreviewWidget;                              // 0x00E0 (size: 0x8)
    TArray<class UMovieGraphScriptBase*> CurrentScriptInstances;                      // 0x00E8 (size: 0x10)
    TSet<UMovieGraphFileOutputNode*> OutputNodesDataSentTo;                           // 0x00F8 (size: 0x50)
    class UMovieGraphEngineTimeStep* CustomEngineTimeStep;                            // 0x01B8 (size: 0x8)
    class UEngineCustomTimeStep* PrevCustomEngineTimeStep;                            // 0x01C0 (size: 0x8)
...
{
    TSubclassOf<class UMovieGraphSettingNode> NodeType;                               // 0x0098 (size: 0x8)
...
{
    uint8 bOverride_LayerName;                                                        // 0x0098 (size: 0x1)
    FString LayerName;                                                                // 0x00A0 (size: 0x10)
...
{
    uint8 bOverride_bIsHidden;                                                        // 0x0048 (size: 0x1)
    uint8 bOverride_bCastsShadows;                                                    // 0x0048 (size: 0x1)
    uint8 bOverride_bCastShadowWhileHidden;                                           // 0x0048 (size: 0x1)
    uint8 bOverride_bAffectIndirectLightingWhileHidden;                               // 0x0048 (size: 0x1)
    uint8 bOverride_bHoldout;                                                         // 0x0048 (size: 0x1)
    uint8 bIsHidden;                                                                  // 0x0048 (size: 0x1)
    uint8 bCastsShadows;                                                              // 0x0048 (size: 0x1)
    uint8 bCastShadowWhileHidden;                                                     // 0x0048 (size: 0x1)
    uint8 bAffectIndirectLightingWhileHidden;                                         // 0x0049 (size: 0x1)
    uint8 bHoldout;                                                                   // 0x0049 (size: 0x1)
...
{
    uint8 bOverride_SamplingMethodClass;                                              // 0x0098 (size: 0x1)
    uint8 bOverride_TemporalSampleCount;                                              // 0x0098 (size: 0x1)
    FSoftClassPath SamplingMethodClass;                                               // 0x00A0 (size: 0x20)
    int32 TemporalSampleCount;                                                        // 0x00C0 (size: 0x4)
...
{
    class UMovieGraphValueContainer* SelectOptions;                                   // 0x0098 (size: 0x8)
    class UMovieGraphValueContainer* SelectedOption;                                  // 0x00A0 (size: 0x8)
...
{
    uint8 bOverride_Name;                                                             // 0x0098 (size: 0x1)
    uint8 bOverride_Value;                                                            // 0x0098 (size: 0x1)
    FString Name;                                                                     // 0x00A0 (size: 0x10)
    float Value;                                                                      // 0x00B0 (size: 0x4)
...
{
    TSoftObjectPtr<UMovieGraphConfig> SubgraphAsset;                                  // 0x0098 (size: 0x28)
...
{
    class UMovieGraphVariable* GraphVariable;                                         // 0x0098 (size: 0x8)
    FMovieGraphPinProperties OutputPin;                                               // 0x00A0 (size: 0x20)
...
{
    uint8 bOverride_NumWarmUpFrames;                                                  // 0x0098 (size: 0x1)
    uint8 bOverride_bEmulateMotionBlur;                                               // 0x0098 (size: 0x1)
    int32 NumWarmUpFrames;                                                            // 0x009C (size: 0x4)
    bool bEmulateMotionBlur;                                                          // 0x00A0 (size: 0x1)

}; // Size: 0xA8

class UMovieGraphWidgetRendererBaseNode : public UMovieGraphRenderPassNode
{
    uint8 bOverride_bCompositeOntoFinalImage;                                         // 0x0098 (size: 0x1)
    bool bCompositeOntoFinalImage;                                                    // 0x0099 (size: 0x1)
...
{
    FMoviePipelineOnMoviePipelineFinishedDelegate OnMoviePipelineFinishedDelegate;    // 0x0078 (size: 0x10)
    void MoviePipelineFinished(class UMoviePipeline* MoviePipeline, bool bFatalError);
    class UMoviePipelineCustomTimeStep* CustomTimeStep;                               // 0x0088 (size: 0x8)
    class UEngineCustomTimeStep* CachedPrevCustomTimeStep;                            // 0x00A0 (size: 0x8)
    class ULevelSequence* TargetSequence;                                             // 0x00A8 (size: 0x8)
    class ALevelSequenceActor* LevelSequenceActor;                                    // 0x00B0 (size: 0x8)
    class UMovieRenderDebugWidget* DebugWidget;                                       // 0x00B8 (size: 0x8)
    class UTexture* PreviewTexture;                                                   // 0x00C0 (size: 0x8)
    TSubclassOf<class UMovieRenderDebugWidget> DebugWidgetClass;                      // 0x0328 (size: 0x8)
    class UMoviePipelineExecutorJob* CurrentJob;                                      // 0x0338 (size: 0x8)
...
class UMoviePipelineBlueprintLibrary : public UBlueprintFunctionLibrary
{
    ...
    FIntPoint GetEffectiveOutputResolution(class UMoviePipelinePrimaryConfig* InPrimaryConfig, class UMoviePipelineExecutorShot* InPipelineExecutorShot);
...
{
    FOpenColorIODisplayConfiguration OCIOConfiguration;                               // 0x0048 (size: 0xA0)
    bool bDisableToneCurve;                                                           // 0x00E8 (size: 0x1)
...
class UMoviePipelineExecutorJob : public UObject
{
    ...
    FString StatusMessage;                                                            // 0x00D0 (size: 0x10)
    float StatusProgress;                                                             // 0x00E0 (size: 0x4)
    bool bIsConsumed;                                                                 // 0x00E4 (size: 0x1)
    class UMoviePipelinePrimaryConfig* Configuration;                                 // 0x00E8 (size: 0x8)
    TSoftObjectPtr<UMoviePipelinePrimaryConfig> PresetOrigin;                         // 0x00F0 (size: 0x28)
    bool bEnabled;                                                                    // 0x0118 (size: 0x1)
    TSoftObjectPtr<UMovieGraphConfig> GraphPreset;                                    // 0x0120 (size: 0x28)
    TArray<class UMovieJobVariableAssignmentContainer*> GraphVariableAssignments;     // 0x0148 (size: 0x10)
...
class UMoviePipelineExecutorShot : public UObject
{
    ...
    float Progress;                                                                   // 0x0140 (size: 0x4)
    FString StatusMessage;                                                            // 0x0148 (size: 0x10)
    class UMoviePipelineShotConfig* ShotOverrideConfig;                               // 0x0158 (size: 0x8)
    TSoftObjectPtr<UMoviePipelineShotConfig> ShotOverridePresetOrigin;                // 0x0160 (size: 0x28)
    TSoftObjectPtr<UMovieGraphConfig> GraphPreset;                                    // 0x0188 (size: 0x28)
    TArray<class UMovieJobVariableAssignmentContainer*> GraphVariableAssignments;     // 0x01B0 (size: 0x10)
    TArray<class UMovieJobVariableAssignmentContainer*> PrimaryGraphVariableAssignments; // 0x01C0 (size: 0x10)
