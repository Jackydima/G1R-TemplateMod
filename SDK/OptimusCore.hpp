...
{
    FName Category;                                                                   // 0x0260 (size: 0x8)
    FName KernelName;                                                                 // 0x0268 (size: 0x8)
    FOptimusExecutionDomain ExecutionDomain;                                          // 0x0270 (size: 0x20)
    FIntVector GroupSize;                                                             // 0x0290 (size: 0xC)
    TArray<FOptimusParameterBinding> InputBindings;                                   // 0x02A0 (size: 0x10)
    TArray<FOptimusParameterBinding> OutputBindings;                                  // 0x02B0 (size: 0x10)
    FString ShaderSource;                                                             // 0x02C0 (size: 0x10)
...
{
    FOptimusDataTypeRef DataType;                                                     // 0x0260 (size: 0x10)
