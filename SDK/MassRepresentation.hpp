...
{
    class UMassVisualizationComponent* VisComponent;                                  // 0x0290 (size: 0x8)

}; // Size: 0x298

class UMassDistanceLODProcessor : public UMassProcessor
{
    class UScriptStruct* FilterTag;                                                   // 0x08A8 (size: 0x8)
...
{
    FMassRepresentationUpdateParams UpdateParams;                                     // 0x0360 (size: 0x1)

}; // Size: 0x370

class UMassRepresentationSubsystem : public UMassSubsystemBase
{
    TArray<class TSubclassOf<AActor>> TemplateActors;                                 // 0x0038 (size: 0x10)
    class UMassVisualizationComponent* VisualizationComponent;                        // 0x0048 (size: 0x8)
    class AMassVisualizer* Visualizer;                                                // 0x0050 (size: 0x8)
    class UMassActorSpawnerSubsystem* ActorSpawnerSubsystem;                          // 0x0058 (size: 0x8)
    class UWorldPartitionSubsystem* WorldPartitionSubsystem;                          // 0x0070 (size: 0x8)
...
{
    class UScriptStruct* FilterTag;                                                   // 0x0B48 (size: 0x8)
    bool bDoAdjustmentFromCount;                                                      // 0x0B50 (size: 0x1)
