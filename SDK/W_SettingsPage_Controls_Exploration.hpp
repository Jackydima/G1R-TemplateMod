#ifndef UE4SS_SDK_W_SettingsPage_Controls_Exploration_HPP
#define UE4SS_SDK_W_SettingsPage_Controls_Exploration_HPP

class UW_SettingsPage_Controls_Exploration_C : public UAlkUserWidget
{
    ...
    void ExecuteUbergraph_W_SettingsPage_Controls_Exploration(int32 EntryPoint);
}; // Size: 0x370
