#ifndef UE4SS_SDK_W_SettingsPage_Test_HPP
#define UE4SS_SDK_W_SettingsPage_Test_HPP

class UW_SettingsPage_Test_C : public USettingsPageWidget
{
    ...
    void BP_OnActivated();
    void ExecuteUbergraph_W_SettingsPage_Test(int32 EntryPoint);
}; // Size: 0x4D0
