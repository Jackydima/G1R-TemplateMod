...
struct FSmartObjectRequest
{
    ...
    FSmartObjectRequestFilter Filter;                                                 // 0x0040 (size: 0xF0)
...
struct FSmartObjectRequestFilter
{
    ...
    FGameplayTagContainer UserTags;                                                   // 0x0008 (size: 0x20)
    ESmartObjectClaimPriority ClaimPriority;                                          // 0x0028 (size: 0x1)
    FGameplayTagQuery ActivityRequirements;                                           // 0x0030 (size: 0x48)
    TArray<class TSubclassOf<USmartObjectBehaviorDefinition>> BehaviorDefinitionClasses; // 0x0078 (size: 0x10)
    bool bShouldEvaluateConditions;                                                   // 0x0088 (size: 0x1)
    bool bShouldIncludeClaimedSlots;                                                  // 0x0089 (size: 0x1)
    bool bShouldIncludeDisabledSlots;                                                 // 0x008A (size: 0x1)
...
{
    FBox Bounds;                                                                      // 0x0290 (size: 0x38)
    TArray<FSmartObjectCollectionEntry> CollectionEntries;                            // 0x02C8 (size: 0x10)
    TMap<class FSmartObjectHandle, class FSoftObjectPath> RegisteredIdToObjectMap;    // 0x02D8 (size: 0x50)
    TArray<class USmartObjectDefinition*> Definitions;                                // 0x0328 (size: 0x10)

}; // Size: 0x340

class AGenericSmartObject : public AActor
{
    class USmartObjectComponent* SOComponent;                                         // 0x0290 (size: 0x8)

}; // Size: 0x298

class ASmartObjectPersistentCollection : public AActor
{
    FSmartObjectContainer SmartObjectContainer;                                       // 0x0290 (size: 0xB0)

}; // Size: 0x348

class ASmartObjectSubsystemRenderingActor : public AActor
{
    class USmartObjectSubsystemRenderingComponent* RenderingComponent;                // 0x0290 (size: 0x8)

}; // Size: 0x298

class ASmartObjectTestingActor : public AActor
{
    TArray<class USmartObjectTest*> Tests;                                            // 0x0290 (size: 0x10)
    class USmartObjectTestRenderingComponent* RenderingComponent;                     // 0x02A0 (size: 0x8)
    class USmartObjectSubsystem* SmartObjectSubsystem;                                // 0x02A8 (size: 0x8)
    bool bRunTestsEachFrame;                                                          // 0x02B0 (size: 0x1)
...
class UEnvQueryGenerator_SmartObjects : public UEnvQueryGenerator
{
    ...
    FSmartObjectRequestFilter SmartObjectRequestFilter;                               // 0x0060 (size: 0xF0)
    FVector QueryBoxExtent;                                                           // 0x0150 (size: 0x18)
    bool bOnlyClaimable;                                                              // 0x0168 (size: 0x1)
...
{
    FSmartObjectRequest Request;                                                      // 0x0030 (size: 0x130)
    TArray<FSmartObjectRequestResult> Results;                                        // 0x0160 (size: 0x10)
...
class USmartObjectSubsystem : public UWorldSubsystem
{
    ...
    class USmartObjectBehaviorDefinition* Use(const FSmartObjectClaimHandle& ClaimHandle, TSubclassOf<class USmartObjectBehaviorDefinition> DefinitionClass);
    ...
    FSmartObjectClaimHandle Claim(const FSmartObjectRequestResult& RequestResult, const class AActor* UserActor);
