#ifndef UE4SS_SDK_W_Controls_XBox_Combat_HPP
#define UE4SS_SDK_W_Controls_XBox_Combat_HPP

class UW_Controls_XBox_Combat_C : public UUserWidget
{
    ...
    class UTextBlock* TextBlock_RightStickPress;                                      // 0x0360 (size: 0x8)
    class UTextBlock* TextBlock_RightStickPress_1;                                    // 0x0368 (size: 0x8)
    class UTexture2D* Image;                                                          // 0x0370 (size: 0x8)
    TArray<FText> ButtonText;                                                         // 0x0378 (size: 0x10)

    void SetInfo();
    void PreConstruct(bool IsDesignTime);
    void ExecuteUbergraph_W_Controls_XBox_Combat(int32 EntryPoint);
}; // Size: 0x388
