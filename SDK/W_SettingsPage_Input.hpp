#ifndef UE4SS_SDK_W_SettingsPage_Input_HPP
#define UE4SS_SDK_W_SettingsPage_Input_HPP

class UW_SettingsPage_Input_C : public USettingsPageWidget
{
    ...
    class UW_SettingsRow_C* W_SettingsRow_MouseRetargetingSensibility;                // 0x04D0 (size: 0x8)
    ...
    void BP_OnActivated();
    void ExecuteUbergraph_W_SettingsPage_Input(int32 EntryPoint);
}; // Size: 0x4D8
