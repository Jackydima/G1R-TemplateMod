...
class ULiveLinkSettings : public UObject
{
    ...
    float ClockOffsetCorrectionStep;                                                  // 0x0068 (size: 0x4)
    ELiveLinkSourceMode DefaultMessageBusSourceMode;                                  // 0x006C (size: 0x1)
    double MessageBusPingRequestFrequency;                                            // 0x0070 (size: 0x8)
    double MessageBusHeartbeatFrequency;                                              // 0x0078 (size: 0x8)
    double MessageBusHeartbeatTimeout;                                                // 0x0080 (size: 0x8)
    double MessageBusTimeBeforeRemovingInactiveSource;                                // 0x0088 (size: 0x8)
    double TimeWithoutFrameToBeConsiderAsInvalid;                                     // 0x0090 (size: 0x8)
    FLinearColor ValidColor;                                                          // 0x0098 (size: 0x10)
    FLinearColor InvalidColor;                                                        // 0x00A8 (size: 0x10)
    uint8 TextSizeSource;                                                             // 0x00B8 (size: 0x1)
    uint8 TextSizeSubject;                                                            // 0x00B9 (size: 0x1)
