#ifndef UE4SS_SDK_W_Controls_PS_Combat_HPP
#define UE4SS_SDK_W_Controls_PS_Combat_HPP

class UW_Controls_PS_Combat_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_W_Controls_PS_Combat(int32 EntryPoint);
}; // Size: 0x388
