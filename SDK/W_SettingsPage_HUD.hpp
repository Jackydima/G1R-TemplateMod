#ifndef UE4SS_SDK_W_SettingsPage_HUD_HPP
#define UE4SS_SDK_W_SettingsPage_HUD_HPP

class UW_SettingsPage_HUD_C : public USettingsPageWidget
{
    ...
    void BP_OnActivated();
    void ExecuteUbergraph_W_SettingsPage_HUD(int32 EntryPoint);
}; // Size: 0x4D0
