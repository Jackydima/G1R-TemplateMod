...
{
    class UWidgetTree* WidgetTree;                                                    // 0x03C0 (size: 0x8)
    TArray<class UWidgetBlueprintGeneratedClassExtension*> Extensions;                // 0x03C8 (size: 0x10)
    uint8 bClassRequiresNativeTick;                                                   // 0x03D8 (size: 0x1)
    uint8 bCanCallInitializedWithoutPlayerContext;                                    // 0x03D8 (size: 0x1)
    TArray<FDelegateRuntimeBinding> Bindings;                                         // 0x03E0 (size: 0x10)
    TArray<class UWidgetAnimation*> Animations;                                       // 0x03F0 (size: 0x10)
    TArray<FName> NamedSlots;                                                         // 0x0400 (size: 0x10)
    TArray<FName> AvailableNamedSlots;                                                // 0x0410 (size: 0x10)
    TArray<FName> InstanceNamedSlots;                                                 // 0x0420 (size: 0x10)
