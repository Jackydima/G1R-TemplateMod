#ifndef UE4SS_SDK_OrcWhetstone_AnimBP_HPP
#define UE4SS_SDK_OrcWhetstone_AnimBP_HPP

struct FAnimBlueprintGeneratedConstantData : public FAnimBlueprintConstantData
{
    FName __NameProperty_10;                                                          // 0x0004 (size: 0x8)
    FAnimNodeFunctionRef __StructProperty_11;                                         // 0x0010 (size: 0x20)
    bool __BoolProperty_12;                                                           // 0x0030 (size: 0x1)
    float __FloatProperty_13;                                                         // 0x0034 (size: 0x4)
    FInputScaleBiasClampConstants __StructProperty_14;                                // 0x0038 (size: 0x2C)
    float __FloatProperty_15;                                                         // 0x0064 (size: 0x4)
    bool __BoolProperty_16;                                                           // 0x0068 (size: 0x1)
    EAnimSyncMethod __EnumProperty_17;                                                // 0x0069 (size: 0x1)
    TEnumAsByte<EAnimGroupRole::Type> __ByteProperty_18;                              // 0x006A (size: 0x1)
    FName __NameProperty_19;                                                          // 0x006C (size: 0x8)
...
class UOrcWhetstone_AnimBP_C : public UAnimInstance
{
    ...
    void ExecuteUbergraph_OrcWhetstone_AnimBP(int32 EntryPoint);
}; // Size: 0x438
