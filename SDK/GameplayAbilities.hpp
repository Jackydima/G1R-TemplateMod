...
struct FGameplayAbilityLocalAnimMontage
{
    ...
    TWeakObjectPtr<class UGameplayAbility> AnimatingAbility;                          // 0x0020 (size: 0x8)
...
struct FGameplayAbilitySpec : public FFastArraySerializerItem
{
    ...
    FGameplayAbilityActivationInfo ActivationInfo;                                    // 0x0040 (size: 0x18)
...
{
    FHitResult HitResult;                                                             // 0x0008 (size: 0xF8)
    bool bHitReplaced;                                                                // 0x0100 (size: 0x1)
...
{
    class UAbilitySystemComponent* AbilitySystemComponent;                            // 0x0358 (size: 0x8)

}; // Size: 0x360

class AGameplayAbilityTargetActor : public AActor
{
    bool ShouldProduceTargetDataOnServer;                                             // 0x0290 (size: 0x1)
...
{
    FWorldReticleParameters Parameters;                                               // 0x0290 (size: 0x18)
    bool bFaceOwnerFlat;                                                              // 0x02A8 (size: 0x1)
    bool bSnapToTargetedActor;                                                        // 0x02A9 (size: 0x1)
    bool bIsTargetValid;                                                              // 0x02AA (size: 0x1)
    bool bIsTargetAnActor;                                                            // 0x02AB (size: 0x1)
    class APlayerController* PrimaryPC;                                               // 0x02B0 (size: 0x8)
    class AGameplayAbilityTargetActor* TargetingActor;                                // 0x02B8 (size: 0x8)
...
{
    class UCapsuleComponent* CollisionComponent;                                      // 0x02C0 (size: 0x8)
    TArray<class UActorComponent*> VisualizationComponents;                           // 0x02C8 (size: 0x10)

}; // Size: 0x2D8

class AGameplayCueNotify_Actor : public AActor
{
    bool bAutoDestroyOnRemove;                                                        // 0x0290 (size: 0x1)
    float AutoDestroyDelay;                                                           // 0x0294 (size: 0x4)
    bool WarnIfTimelineIsStillRunning;                                                // 0x0298 (size: 0x1)
    bool WarnIfLatentActionIsStillRunning;                                            // 0x0299 (size: 0x1)
    FGameplayTag GameplayCueTag;                                                      // 0x029C (size: 0x8)
    FName GameplayCueName;                                                            // 0x02A4 (size: 0x8)
    bool bAutoAttachToOwner;                                                          // 0x02AC (size: 0x1)
    bool IsOverride;                                                                  // 0x02AD (size: 0x1)
    bool bUniqueInstancePerInstigator;                                                // 0x02AE (size: 0x1)
    bool bUniqueInstancePerSourceObject;                                              // 0x02AF (size: 0x1)
    bool bAllowMultipleOnActiveEvents;                                                // 0x02B0 (size: 0x1)
    bool bAllowMultipleWhileActiveEvents;                                             // 0x02B1 (size: 0x1)
    int32 NumPreallocatedInstances;                                                   // 0x02B4 (size: 0x4)
...
{
    FGameplayCueNotify_SpawnCondition DefaultSpawnCondition;                          // 0x0300 (size: 0x38)
    FGameplayCueNotify_PlacementInfo DefaultPlacementInfo;                            // 0x0338 (size: 0x40)
    FGameplayCueNotify_BurstEffects BurstEffects;                                     // 0x0378 (size: 0x298)
    FGameplayCueNotify_SpawnResult BurstSpawnResults;                                 // 0x0610 (size: 0x58)
...
class AGameplayCueNotify_Looping : public AGameplayCueNotify_Actor
{
    FGameplayCueNotify_SpawnCondition DefaultSpawnCondition;                          // 0x0300 (size: 0x38)
    FGameplayCueNotify_PlacementInfo DefaultPlacementInfo;                            // 0x0338 (size: 0x40)
    FGameplayCueNotify_BurstEffects ApplicationEffects;                               // 0x0378 (size: 0x298)
    FGameplayCueNotify_SpawnResult ApplicationSpawnResults;                           // 0x0610 (size: 0x58)
    FGameplayCueNotify_LoopingEffects LoopingEffects;                                 // 0x0668 (size: 0x1F0)
    FGameplayCueNotify_SpawnResult LoopingSpawnResults;                               // 0x0858 (size: 0x58)
    FGameplayCueNotify_BurstEffects RecurringEffects;                                 // 0x08B0 (size: 0x298)
    FGameplayCueNotify_SpawnResult RecurringSpawnResults;                             // 0x0B48 (size: 0x58)
    FGameplayCueNotify_BurstEffects RemovalEffects;                                   // 0x0BA0 (size: 0x298)
    FGameplayCueNotify_SpawnResult RemovalSpawnResults;                               // 0x0E38 (size: 0x58)
...
class UAbilitySystemComponent : public UGameplayTasksComponent
{
    ...
    FGameplayAbilityRepAnimMontage RepAnimMontageInfo;                                // 0x0768 (size: 0x40)
    bool bCachedIsNetSimulated;                                                       // 0x07A8 (size: 0x1)
    bool bPendingMontageRep;                                                          // 0x07A9 (size: 0x1)
    FGameplayAbilityLocalAnimMontage LocalAnimMontageInfo;                            // 0x07B0 (size: 0x28)
    FActiveGameplayEffectsContainer ActiveGameplayEffects;                            // 0x0878 (size: 0x300)
    FActiveGameplayCueContainer ActiveGameplayCues;                                   // 0x0B78 (size: 0x128)
    FActiveGameplayCueContainer MinimalReplicationGameplayCues;                       // 0x0CA0 (size: 0x128)
    TArray<uint8> BlockedAbilityBindings;                                             // 0x0EF0 (size: 0x10)
    FMinimalReplicationTagCountMap MinimalReplicationTags;                            // 0x1028 (size: 0x68)
    TArray<class UAttributeSet*> SpawnedAttributes;                                   // 0x1090 (size: 0x10)
    FMinimalReplicationTagCountMap ReplicatedLooseTags;                               // 0x10B0 (size: 0x68)
    FReplicatedPredictionKeyMap ReplicatedPredictionKeyMap;                           // 0x1120 (size: 0x118)
