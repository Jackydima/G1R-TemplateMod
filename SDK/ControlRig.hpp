...
struct FRigUnit_SphereTraceByObjectTypes : public FRigUnit
{
    ...
    bool UseComplex;                                                                  // 0x0048 (size: 0x1)
    float Radius;                                                                     // 0x004C (size: 0x4)
    bool bHit;                                                                        // 0x0050 (size: 0x1)
    FVector HitLocation;                                                              // 0x0058 (size: 0x18)
    FVector HitNormal;                                                                // 0x0070 (size: 0x18)
    FRigUnit_SphereTrace_WorkData WorkData;                                           // 0x0088 (size: 0x38)
...
struct FRigUnit_SphereTraceByTraceChannel : public FRigUnit
{
    ...
    bool UseComplex;                                                                  // 0x0039 (size: 0x1)
