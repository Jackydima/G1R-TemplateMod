...
{
    FMassSpawnerOnSpawningFinishedEvent OnSpawningFinishedEvent;                      // 0x0290 (size: 0x10)
    void MassSpawnerOnSpawningFinishedEvent();
    FMassSpawnerOnDespawningFinishedEvent OnDespawningFinishedEvent;                  // 0x02A0 (size: 0x10)
    void MassSpawnerOnDespawningFinishedEvent();
    int32 Count;                                                                      // 0x02B0 (size: 0x4)
    TArray<FMassSpawnedEntityType> EntityTypes;                                       // 0x02B8 (size: 0x10)
    TArray<FMassSpawnDataGenerator> SpawnDataGenerators;                              // 0x02C8 (size: 0x10)
    uint8 bAutoSpawnOnBeginPlay;                                                      // 0x02D8 (size: 0x1)
    uint8 bOverrideSchematics;                                                        // 0x02D8 (size: 0x1)
    TArray<class UMassProcessor*> PostSpawnProcessors;                                // 0x02E0 (size: 0x10)
    float SpawningCountScale;                                                         // 0x02F0 (size: 0x4)
...
class UDEPRECATED_MassEntityTemplateRegistry : public UObject
{
}; // Size: 0x28
