#ifndef UE4SS_SDK_W_Controls_XBox_Exploration_HPP
#define UE4SS_SDK_W_Controls_XBox_Exploration_HPP

class UW_Controls_XBox_Exploration_C : public UUserWidget
{
    ...
    class UTextBlock* TextBlock_MapHold;                                              // 0x0360 (size: 0x8)
    class UTextBlock* TextBlock_Menu;                                                 // 0x0368 (size: 0x8)
    class UTextBlock* TextBlock_Option;                                               // 0x0370 (size: 0x8)
    class UTextBlock* TextBlock_R2;                                                   // 0x0378 (size: 0x8)
    class UTextBlock* TextBlock_RightStick;                                           // 0x0380 (size: 0x8)
    class UTexture2D* Image;                                                          // 0x0388 (size: 0x8)
    TArray<FText> ButtonText;                                                         // 0x0390 (size: 0x10)

    void SetInfo();
    void PreConstruct(bool IsDesignTime);
    void ExecuteUbergraph_W_Controls_XBox_Exploration(int32 EntryPoint);
}; // Size: 0x3A0
