...
struct FCommonInputActionDataBase : public FTableRowBase
{
    ...
    FCommonInputTypeInfo KeyboardInputTypeInfo;                                       // 0x0030 (size: 0x100)
    FCommonInputTypeInfo DefaultGamepadInputTypeInfo;                                 // 0x0130 (size: 0x100)
    TMap<class FName, class FCommonInputTypeInfo> GamepadInputOverrides;              // 0x0230 (size: 0x50)
    FCommonInputTypeInfo TouchInputTypeInfo;                                          // 0x0280 (size: 0x100)
...
{
    FCommonActionWidgetOnInputMethodChanged OnInputMethodChanged;                     // 0x0178 (size: 0x10)
...
{
    bool bIsBackHandler;                                                              // 0x0308 (size: 0x1)
    bool bIsBackActionDisplayedInActionBar;                                           // 0x0309 (size: 0x1)
    bool bAutoActivate;                                                               // 0x030A (size: 0x1)
    bool bSupportsActivationFocus;                                                    // 0x030B (size: 0x1)
    bool bIsModal;                                                                    // 0x030C (size: 0x1)
    bool bAutoRestoreFocus;                                                           // 0x030D (size: 0x1)
    bool bOverrideActionDomain;                                                       // 0x030E (size: 0x1)
    class UInputMappingContext* InputMapping;                                         // 0x0310 (size: 0x8)
    int32 InputMappingPriority;                                                       // 0x0318 (size: 0x4)
    TSoftObjectPtr<UCommonInputActionDomain> ActionDomainOverride;                    // 0x0320 (size: 0x28)
    FCommonActivatableWidgetBP_OnWidgetActivated BP_OnWidgetActivated;                // 0x0348 (size: 0x10)
    void OnWidgetActivationChanged();
    FCommonActivatableWidgetBP_OnWidgetDeactivated BP_OnWidgetDeactivated;            // 0x0358 (size: 0x10)
    void OnWidgetActivationChanged();
    bool bIsActive;                                                                   // 0x0368 (size: 0x1)
    TArray<TWeakObjectPtr<UCommonActivatableWidget>> VisibilityBoundWidgets;          // 0x0370 (size: 0x10)
    bool bSetVisibilityOnActivated;                                                   // 0x0428 (size: 0x1)
    ESlateVisibility ActivatedVisibility;                                             // 0x0429 (size: 0x1)
    bool bSetVisibilityOnDeactivated;                                                 // 0x042A (size: 0x1)
    ESlateVisibility DeactivatedVisibility;                                           // 0x042B (size: 0x1)
...
{
    ECommonSwitcherTransition TransitionType;                                         // 0x0190 (size: 0x1)
    ETransitionCurve TransitionCurveType;                                             // 0x0191 (size: 0x1)
    float TransitionDuration;                                                         // 0x0194 (size: 0x4)
    ECommonSwitcherTransitionFallbackStrategy TransitionFallbackStrategy;             // 0x0198 (size: 0x1)
...
{
    bool bClearFocusRestorationTargetOfDeactivatedWidgets;                            // 0x0230 (size: 0x1)

}; // Size: 0x240

class UCommonAnimatedSwitcher : public UWidgetSwitcher
{
    FCommonAnimatedSwitcherOnActiveWidgetIndexChangedBP OnActiveWidgetIndexChangedBP; // 0x01D8 (size: 0x10)
    void OnActiveIndexChangedDelegate(class UWidget* ActiveWidget, int32 ActiveIndex);
    ECommonSwitcherTransition TransitionType;                                         // 0x01E8 (size: 0x1)
    ETransitionCurve TransitionCurveType;                                             // 0x01E9 (size: 0x1)
    float TransitionDuration;                                                         // 0x01EC (size: 0x4)
    ECommonSwitcherTransitionFallbackStrategy TransitionFallbackStrategy;             // 0x01F0 (size: 0x1)
...
{
    TSubclassOf<class UCommonButtonBase> ActionButtonClass;                           // 0x0260 (size: 0x8)
    bool bDisplayOwningPlayerActionsOnly;                                             // 0x0268 (size: 0x1)
    bool bIgnoreDuplicateActions;                                                     // 0x0269 (size: 0x1)
    FCommonBoundActionBarOnActionBarUpdated OnActionBarUpdated;                       // 0x0270 (size: 0x10)
...
{
    class UCommonTextBlock* Text_ActionName;                                          // 0x15A8 (size: 0x8)
...
{
    FWidgetEventField ClickEvent;                                                     // 0x0308 (size: 0x1)
    int32 MinWidth;                                                                   // 0x030C (size: 0x4)
    int32 MinHeight;                                                                  // 0x0310 (size: 0x4)
    TSubclassOf<class UCommonButtonStyle> Style;                                      // 0x0318 (size: 0x8)
    bool bHideInputAction;                                                            // 0x0320 (size: 0x1)
    FSlateSound PressedSlateSoundOverride;                                            // 0x0328 (size: 0x18)
    FSlateSound HoveredSlateSoundOverride;                                            // 0x0340 (size: 0x18)
    FSlateSound SelectedPressedSlateSoundOverride;                                    // 0x0358 (size: 0x18)
    FSlateSound SelectedHoveredSlateSoundOverride;                                    // 0x0370 (size: 0x18)
    FSlateSound LockedPressedSlateSoundOverride;                                      // 0x0388 (size: 0x18)
    FSlateSound LockedHoveredSlateSoundOverride;                                      // 0x03A0 (size: 0x18)
    uint8 bApplyAlphaOnDisable;                                                       // 0x03B8 (size: 0x1)
    uint8 bLocked;                                                                    // 0x03B8 (size: 0x1)
    uint8 bSelectable;                                                                // 0x03B8 (size: 0x1)
    uint8 bShouldSelectUponReceivingFocus;                                            // 0x03B8 (size: 0x1)
    uint8 bInteractableWhenSelected;                                                  // 0x03B8 (size: 0x1)
    uint8 bToggleable;                                                                // 0x03B8 (size: 0x1)
    uint8 bTriggerClickedAfterSelection;                                              // 0x03B8 (size: 0x1)
    uint8 bDisplayInputActionWhenNotInteractable;                                     // 0x03B8 (size: 0x1)
    uint8 bHideInputActionWithKeyboard;                                               // 0x03B9 (size: 0x1)
    uint8 bShouldUseFallbackDefaultInputAction;                                       // 0x03B9 (size: 0x1)
    uint8 bRequiresHold;                                                              // 0x03B9 (size: 0x1)
    TSubclassOf<class UCommonUIHoldData> HoldData;                                    // 0x03C0 (size: 0x8)
    bool bSimulateHoverOnTouchInput;                                                  // 0x03C8 (size: 0x1)
    TEnumAsByte<EButtonClickMethod::Type> ClickMethod;                                // 0x03CA (size: 0x1)
    TEnumAsByte<EButtonTouchMethod::Type> TouchMethod;                                // 0x03CB (size: 0x1)
    TEnumAsByte<EButtonPressMethod::Type> PressMethod;                                // 0x03CC (size: 0x1)
    int32 InputPriority;                                                              // 0x03D0 (size: 0x4)
    FDataTableRowHandle TriggeringInputAction;                                        // 0x03D8 (size: 0x10)
    class UInputAction* TriggeringEnhancedInputAction;                                // 0x03E8 (size: 0x8)
    FCommonButtonBaseOnSelectedChangedBase OnSelectedChangedBase;                     // 0x0400 (size: 0x10)
    void CommonSelectedStateChangedBase(class UCommonButtonBase* Button, bool Selected);
    FCommonButtonBaseOnButtonBaseClicked OnButtonBaseClicked;                         // 0x0410 (size: 0x10)
    void CommonButtonBaseClicked(class UCommonButtonBase* Button);
    FCommonButtonBaseOnButtonBaseDoubleClicked OnButtonBaseDoubleClicked;             // 0x0420 (size: 0x10)
    void CommonButtonBaseClicked(class UCommonButtonBase* Button);
    FCommonButtonBaseOnButtonBaseHovered OnButtonBaseHovered;                         // 0x0430 (size: 0x10)
    void CommonButtonBaseClicked(class UCommonButtonBase* Button);
    FCommonButtonBaseOnButtonBaseUnhovered OnButtonBaseUnhovered;                     // 0x0440 (size: 0x10)
    void CommonButtonBaseClicked(class UCommonButtonBase* Button);
    bool bIsPersistentBinding;                                                        // 0x0488 (size: 0x1)
    ECommonInputMode InputModeOverride;                                               // 0x0489 (size: 0x1)
    class UMaterialInstanceDynamic* SingleMaterialStyleMID;                           // 0x04B0 (size: 0x8)
    FButtonStyle NormalStyle;                                                         // 0x04C0 (size: 0x3F0)
    FButtonStyle SelectedStyle;                                                       // 0x08B0 (size: 0x3F0)
    FButtonStyle DisabledStyle;                                                       // 0x0CA0 (size: 0x3F0)
    FButtonStyle LockedStyle;                                                         // 0x1090 (size: 0x3F0)
    uint8 bStopDoubleClickPropagation;                                                // 0x1480 (size: 0x1)
    class UCommonActionWidget* InputActionWidget;                                     // 0x1598 (size: 0x8)
...
{
    FCommonButtonInternalBaseOnDoubleClicked OnDoubleClicked;                         // 0x0618 (size: 0x10)
    void OnButtonClickedEvent();
    int32 MinWidth;                                                                   // 0x0648 (size: 0x4)
    int32 MinHeight;                                                                  // 0x064C (size: 0x4)
    bool bButtonEnabled;                                                              // 0x0650 (size: 0x1)
    bool bInteractionEnabled;                                                         // 0x0651 (size: 0x1)
...
{
    FText CustomTimespanFormat;                                                       // 0x0398 (size: 0x10)
    bool bCustomTimespanLeadingZeros;                                                 // 0x03A8 (size: 0x1)
...
{
    FSlateBrush LoadingBackgroundBrush;                                               // 0x0190 (size: 0xD0)
    TEnumAsByte<EHorizontalAlignment> ThrobberAlignment;                              // 0x0260 (size: 0x1)
    FMargin ThrobberPadding;                                                          // 0x0264 (size: 0x10)
    FText LoadingText;                                                                // 0x0278 (size: 0x10)
    TSubclassOf<class UCommonTextStyle> TextStyle;                                    // 0x0288 (size: 0x8)
    FCommonLoadGuardBP_OnLoadingStateChanged BP_OnLoadingStateChanged;                // 0x0290 (size: 0x10)
    void OnLoadGuardStateChangedDynamic(bool bIsLoading);
    FSoftObjectPath SpinnerMaterialPath;                                              // 0x02A0 (size: 0x20)
...
{
    FCommonRotatorOnRotatedWithDirection OnRotatedWithDirection;                      // 0x15B0 (size: 0x10)
    void OnRotatedWithDirection(int32 Value, ERotatorDirection RotatorDir);
    FCommonRotatorOnRotated OnRotated;                                                // 0x15C0 (size: 0x10)
    void OnRotated(int32 Value);
    class UCommonTextBlock* MyText;                                                   // 0x15E8 (size: 0x8)
...
{
    FCommonTabListWidgetBaseOnTabSelected OnTabSelected;                              // 0x0308 (size: 0x10)
    void OnTabSelected(FName TabId);
    FCommonTabListWidgetBaseOnTabButtonCreation OnTabButtonCreation;                  // 0x0318 (size: 0x10)
    void OnTabButtonCreation(FName TabId, class UCommonButtonBase* TabButton);
    FCommonTabListWidgetBaseOnTabButtonRemoval OnTabButtonRemoval;                    // 0x0328 (size: 0x10)
    void OnTabButtonRemoval(FName TabId, class UCommonButtonBase* TabButton);
    FCommonTabListWidgetBaseOnTabListRebuilt OnTabListRebuilt;                        // 0x0338 (size: 0x10)
    void OnTabListRebuilt();
    FDataTableRowHandle NextTabInputActionData;                                       // 0x0348 (size: 0x10)
    FDataTableRowHandle PreviousTabInputActionData;                                   // 0x0358 (size: 0x10)
    class UInputAction* NextTabEnhancedInputAction;                                   // 0x0368 (size: 0x8)
    class UInputAction* PreviousTabEnhancedInputAction;                               // 0x0370 (size: 0x8)
    bool bAutoListenForInput;                                                         // 0x0378 (size: 0x1)
    bool bDeferRebuildingTabList;                                                     // 0x0379 (size: 0x1)
    TWeakObjectPtr<class UCommonAnimatedSwitcher> LinkedSwitcher;                     // 0x037C (size: 0x8)
    class UCommonButtonGroupBase* TabButtonGroup;                                     // 0x0388 (size: 0x8)
    TMap<class FName, class FCommonRegisteredTabInfo> RegisteredTabsByID;             // 0x0398 (size: 0x50)
    FUserWidgetPool TabButtonWidgetPool;                                              // 0x03E8 (size: 0x88)
...
class UCommonTextStyle : public UObject
{
    ...
    bool ApplyLineHeightToBottomLine;                                                 // 0x01A4 (size: 0x1)
...
{
    bool bDisplayInActionBar;                                                         // 0x02E0 (size: 0x1)
    bool bConsumePointerInput;                                                        // 0x02E1 (size: 0x1)
...
{
    class UMediaSource* Video;                                                        // 0x0178 (size: 0x8)
    bool bMatchSize;                                                                  // 0x0180 (size: 0x1)
...
{
    ESlateVisibility ShownVisibility;                                                 // 0x01A0 (size: 0x1)
    int32 ActiveWidgetIndex;                                                          // 0x01A4 (size: 0x4)
    bool bAutoActivateSlot;                                                           // 0x01A8 (size: 0x1)
    bool bActivateFirstSlotOnAdding;                                                  // 0x01A9 (size: 0x1)
...
{
    FVector2D ContentAnchor;                                                          // 0x01C8 (size: 0x10)
...
class UCommonWidgetCarousel : public UPanelWidget
{
    ...
    float MoveSpeed;                                                                  // 0x0194 (size: 0x4)
    FCommonWidgetCarouselOnCurrentPageIndexChanged OnCurrentPageIndexChanged;         // 0x0198 (size: 0x10)
...
{
    TSubclassOf<class UCommonButtonBase> ButtonWidgetType;                            // 0x0178 (size: 0x8)
    FMargin ButtonPadding;                                                            // 0x0180 (size: 0x10)
    class UCommonWidgetCarousel* LinkedCarousel;                                      // 0x01A0 (size: 0x8)
    class UCommonButtonGroupBase* ButtonGroup;                                        // 0x01A8 (size: 0x8)
    TArray<class UCommonButtonBase*> Buttons;                                         // 0x01B0 (size: 0x10)
